...
def run_import():
    ...
    files_and_mappings = [
        {
            "file_path": frappe.get_module_path("frappe_insight", "erp/insighQueryforerp.csv"),
        ...
        {
            "file_path": frappe.get_module_path("frappe_insight", "erp/insightdashboard.csv"),
        ...
        {
            "file_path": frappe.get_module_path("frappe_insight", "erp/insightdashboarditem.csv"),
        ...
        {
            "file_path": frappe.get_module_path("frappe_insight", "erp/insightchart.csv"),
    ...
    frappe.msgprint("All Imports Completed SuccessFully")
