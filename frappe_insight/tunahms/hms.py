...
files_and_mappings = [
    {
        "file_path": frappe.get_module_path("frappe_insight", "tunahms/hinsighQuery.csv"),
    ...
    {
        "file_path": frappe.get_module_path("frappe_insight", "tunahms/hinsightdashboard.csv"),
    ...
    {
        "file_path": frappe.get_module_path("frappe_insight", "tunahms/hinsightdashboarditem.csv"),
    ...
    {
        "file_path": frappe.get_module_path("frappe_insight", "tunahms/hinsightchart.csv"),
